...
int gen_scalar_indices( char * dirname ){ /* dirname is the directory to save the .inc files */
...
/*  for ( p = FourD ; p != NULL ; p = p->next )
  ...
  // fprintf(stderr,"HERE in GEN_SCALAR_INDICES.");
  // exit();

  // THIS PART SEEMS TO BE INTERATED OVER PACKAGES; LINKED LIST
