...
#define MAXTOKENS 10000 //5000 /*changed MAXTOKENS from 1000 to 5000 by Manish Shrivastava on 01/28/2010*/
...
int pre_parse( char * dir, FILE * infile, FILE * outfile ){
  ...
  char inln[16000], parseline[16000], parseline_save[16000] ; // 8000 8000 8000
  int found ; 
  char *p, *q ;
...
/* main parse loop over registry lines */
  /* Had to increase size for SOA from 4096 to 10000, bzhao, 6/19/2019 */ // CHANGED BY CHARLES HE
  while ( fgets ( inln , 25000 , infile ) != NULL ){

/*** preprocessing directives ****/
    /* look for an include statement */
    // START; CONDITION; SHIFT;
...
int reg_parse( FILE * infile ){
  ...
  /* Had to increase size for SOA from 4096 to 10000, bzhao, 6/19/2019 */ // CHANGED BY CHARLES HE
  char inln[25000], parseline[25000] ;
  char *p, *q ;
