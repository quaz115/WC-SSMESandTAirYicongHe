...
nc_w_fid.createDimension('bottom_top', 45)
...
bottom_top_w = nc_w_fid.createVariable('bottom_top', np.float32, ('bottom_top',))
...
for var in voc_vars:
    ...
    data_w = nc_w_fid.createVariable(var, np.float32, ('time', 'bottom_top', 'lat', 'lon',))
    data_w[:,:,:, :] = data_all
