...
module wrf_data
  ...
  integer                , parameter      :: MaxDims          = 8000 !2000 ! = NF_MAX_VARS
#if(WRF_CHEM == 1)
  integer                , parameter      :: MaxVars          = 20000 !10000
#else
  integer                , parameter      :: MaxVars          = 20000 !10000 ! bzhao, 6/19/2019, increase from 3000 to 10000 !! CHARLES HE
#endif
