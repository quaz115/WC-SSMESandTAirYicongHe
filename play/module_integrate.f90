     ...
     LOOP0: DO WHILE ( .NOT. domain_clockisstopsubtime(grid) )
     ...
     LOOP1: DO WHILE ( nests_to_open( grid , nestid , kid ) )
     ...
     LOOP2: DO WHILE ( ASSOCIATED( grid_ptr ) )
     ...
     LOOP3: DO WHILE ( ASSOCIATED( grid_ptr ) )
     DO kid = 1, max_nests
